...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(7,'lgcon','category'),(8,'lgcon','menu'),(9,'lgcon','order'),(6,'sessions','session');
